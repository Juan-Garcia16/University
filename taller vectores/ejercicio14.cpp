/*14. Leer 10 números enteros, almacenarlos en un vector y determinar si la semisuma entre el
...
int main(){
    ...
    {
        printf("\nLa semisuma no da un numero entero, es imposible que sea par");
        return 0;
    }
    ...
    if (semisuma % 2 == 0)
    {
        printf("\nLa semisuma es igual a %i, es un numero par\n", semisuma);
    } else {
        printf("\nLa semisuma es igual a %i, NO es un numero par\n", semisuma);
    }
